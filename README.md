...
<body>
    ...
    <section id="articulos" class="articulos">
        <h2>Artículos</h2>
        <p>Leé mis artículos y publicaciones en LinkedIn para estar al tanto de mis últimos trabajos y pensamientos en el campo de la arquitectura y la IA.</p>
